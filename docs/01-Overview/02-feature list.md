# Navigation SDK v1.1.5
UNL Navigation SDK for Flutter offers a powerful and comprehensive set of features that enable developers to integrate seamless mapping and navigation experiences into their applications.

## Key features include:
- **Global Coverage:** Access to up-to-date, high-quality GrabMaps data for Southeast Asia and OpenStreetMap data provides regional-specific and global coverage for mapping and navigation needs.
...
Turn-by-Turn Navigation: Offers optimized routing for car, pedestrian, truck, EV and bicycle navigation, ensuring accurate and efficient routes tailored to each mode of transportation.
...
- **Real-Time Traffic and Incident Information:** Integration of real-time GrabMaps traffic data and incident updates to adjust routes dynamically and improve accuracy.
...
- **Customizable Map Styles:** Customizable map appearance, enabling developers to adjust colors, elements, and design to fit their applications’s branding and user experience.
- **Ready-to-use UI Components:** Prebuilt, optional UI components that can be used as-is or customized to fit your navigation experience.
...
>  🚨 **Alert**: The current release supports Android and iOS platforms. Web support is planned for a future update.
>
