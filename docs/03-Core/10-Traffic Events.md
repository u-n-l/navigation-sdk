...
- **Route traffic information** - See the [Get ETA and Traffic information guide](../07-Routing/02-Get Started wtih Routing.md#retrieve-time-and-distance-information)
