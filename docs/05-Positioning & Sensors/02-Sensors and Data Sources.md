...
The SDK supports the following sensor data types: <br/>
...
More details about the `Position` and `ImprovedPosition` classes are available [here](../03-Core/03-Positions.md).
...
### Create a data source[​](#create-a-data-source "Direct link to Create a data source")
...
### Configure and control a data source[​](#configure-and-control-a-data-source "Direct link to Configure and control a data source")
...
### Use DataSourceListener[​](#use-datasourcelistener "Direct link to Use DataSourceListener")
...
## Use the Playback Interface[​](#use-the-playback-interface "Direct link to Use the Playback interface")
...
## Track positions[​](#track-positions "Direct link to Track positions")
...
### Get tracked positions[​](#get-tracked-positions "Direct link to Get tracked positions")
