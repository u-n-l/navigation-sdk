...
```
> 📝 **Note:** Driver behaviour analysis requires a properly configured `DataSource`. See the [Positioning guide](./05-Positioning & Sensors/03-Get Started wtih Positioning.md) to set up your data pipeline. Start and stop the analysis appropriately and avoid frequent interruptions or overlapping sessions.

## Enable Background Location
To use driver behaviour features while the app is in the background, configure both iOS and Android platforms.

Refer to the [Background Location](./05-Positioning & Sensors/08-Background Location.md) guide for detailed configuration instructions.
